...
class MergingTokenRangeClustererTest {
  ...
  @Test
  def testEmpty() {
    val trc = new MergingTokenRangeClusterer(10)
  ...
  def testTrivialClustering() {
    ...
    val trc = new MergingTokenRangeClusterer[Long, LongToken](10)
  ...
  def testMaxClusterSize() {
    ...
    val trc = new MergingTokenRangeClusterer[Long, LongToken](maxRowCountPerGroup = 10, maxGroupSize = 1)
