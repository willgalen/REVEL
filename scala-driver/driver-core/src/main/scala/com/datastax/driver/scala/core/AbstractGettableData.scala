...
import com.datastax.driver.scala.types.{ UDTValue => ScalaUDTValue }
...
trait AbstractGettableData {
  ...
  @transient
  private[datastax] lazy val _indexOf =
...
object AbstractGettableData {
  ...
  private[datastax] def convert(obj: Any)(implicit protocolVersion: ProtocolVersion): AnyRef = {
    obj match {
      ...
      case udtValue: DriverUDTValue => ScalaUDTValue.apply(udtValue)
