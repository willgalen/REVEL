...
import com.datastax.driver.scala.core.utils.MagicalTypeTricks.{DoesntHaveImplicit, IsNotSubclassOf}
...
object RowReaderFactory extends LowPriorityRowReaderFactoryImplicits {
  ...
  /** Default `RowReader`: reads a `Row` into serializable [[com.datastax.driver.scala.core.CassandraRow]] */
