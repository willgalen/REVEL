...
import com.datastax.driver.scala.testkit.{CassandraSpec, AbstractSpec}
import com.datastax.driver.scala.types._
import org.scalatest.Inspectors._

class SchemaSpec extends AbstractSpec with CassandraSpec {
